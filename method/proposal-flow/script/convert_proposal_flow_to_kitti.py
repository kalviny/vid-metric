...
if __name__ == '__main__':
    ...
    root_path = '/data01/kalviny/dataset/kitti/detection/propsoal_flow/kitti_proposal_300/car/kitti_acf_without_nms/'
    method = 'window_size_3_time_step_1_top_ratio_0.000300_top_bonus_0.400000_optflow/' # 0.4 decay [0.4, 0.5, 0.6, 0.7, 0.8]
    ...
    for vid_name in vid:
        ...
        f = open(vid_out + '/{}.txt'.format(cls), 'w')
        for im_name in im_list:
            ...
            for i in range(len(bbox)):
                ...
                f.write('%d %.6f %.6f %.6f %.6f %.6f\n' % (_name, bbox[i, 4], bbox[i, 0], bbox[i, 1], bbox[i, 2], bbox[i, 3]))
