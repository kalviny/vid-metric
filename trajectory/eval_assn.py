...
"""
    ...
    format: {}
            ...
            val:
                bbox: [[x1, y1, x2, y2], [x1, y1, x2, y2], ...]
"""
def EvalAssn(anno, det, vid_name, score_thr, ov_thr=0.5):
#def EvalAssn(anno, det, score_thr, ov_thr=0.5):
    ...
    for i in range(len(im_list)):
        ...
        nw_bbox = np.array(filter(lambda bbox: bbox[4] >= score_thr, nw_bbox))
    ...
    outdir = 'visualize/2015/output/mot_model0_2015_nms/'
    #outdir = 'visualize/2015/output/mot_model0_2015_weighted_nms_mf_pf/'

    #outdir = 'visualize/2015/output/kitti_nms/'
